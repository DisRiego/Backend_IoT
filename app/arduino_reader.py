...
def device_status_scheduler() -> None:
    ...
    while True:
        ...
        try:
            ...
            # 1) Sin solicitud activa → status 12
            ...
            # 2) Cierre vencido → status 21 + siempre POST "close"
            ...
            # 3) Apertura vigente → status 22 + siempre POST "open"
            rows = db.execute(text("""
